...
replace_in_file "templates/full.liquid" "YOUR_GITHUB_USERNAME" "$GITHUB_USERNAME"
replace_in_file "templates/half_horizontal.liquid" "YOUR_GITHUB_USERNAME" "$GITHUB_USERNAME"
replace_in_file "templates/half_vertical.liquid" "YOUR_GITHUB_USERNAME" "$GITHUB_USERNAME"
replace_in_file "templates/quadrant.liquid" "YOUR_GITHUB_USERNAME" "$GITHUB_USERNAME"
